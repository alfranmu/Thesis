...
\vspace{3cm}
{\Large Tesis sometida a la consideración de la Comisión del Programa de Estudios de Posgrado en Matemática para optar al grado y título de Maestría Académica en Matemática con énfasis en Matemática Pura/Aplicada}
...
\begin{center}
``Esta tesis fue aceptada por la Comisión del Programa de Estudios de Posgrado en Matemática de la Universidad de Costa Rica, como requisito parcial para optar al grado y título de Maestría Profesional en Métodos Matemáticos y Aplicaciones.''
